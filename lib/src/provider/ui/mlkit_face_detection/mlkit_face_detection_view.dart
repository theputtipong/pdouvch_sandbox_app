...
import 'mlkit_face_detection_ctl.dart';

class FaceDetectorView extends StatefulWidget {
  const FaceDetectorView({super.key});

  static const routeName = '/mlkit_face_detection';
...
class _FaceDetectorViewState extends State<FaceDetectorView> {
  ...
  final MLkitFaceDetectionCtl controller = MLkitFaceDetectionCtl();

  _onRequestPermission() async {
    await [
      Permission.camera,
      Permission.videos,
      Permission.sensors,
...
class GalleryView extends StatefulWidget {
  const GalleryView(
      {super.key, required this.title, this.text, required this.onImage, required this.onDetectorViewModeChanged});
